...
@register_model(
    ...
    '/home/ph/LLM/gemma_pytorch/gemma-7b-it',
    LoRATM.llama2,
    TemplateType.gemma,
    requires=['transformers>=4.38'],
    ignore_file_pattern=[r'.+\.gguf$'],
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-MoE-A2.7B',
    LoRATM.qwen1half,
    TemplateType.default_generation,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/MixtralKit-main/Mixtral-8x7B-Instruct-v0.1',
    LoRATM.llama2,
    TemplateType.llama,
    requires=['transformers>=4.36'],
    ignore_file_pattern=[r'.+\.pt$'],
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-32B-Chat-AWQ',
    LoRATM.qwen1half,
    TemplateType.qwen,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-1.8B-Chat',
    LoRATM.qwen1half,
    TemplateType.qwen,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-7B-Chat',
    LoRATM.qwen1half,
    TemplateType.qwen,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-14B-Chat',
    LoRATM.qwen1half,
    TemplateType.qwen,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/Qwen1.5/Qwen1.5-72B-Chat-GPTQ-Int4',
    LoRATM.qwen1half,
    TemplateType.qwen,
    requires=['auto_gptq>=0.5', 'transformers>=4.37'],
    torch_dtype=torch.float16,
...
@register_model(
    ...
    '/home/ph/LLM2/VL/deepseek-vl-7b-chat',
    LoRATM.llama2,
...
@register_model(
    ...
    '/home/ph/LLM/llama3/Meta-Llama-3-70B-Instruct-GPTQ-Int4',
    LoRATM.llama2,
    TemplateType.llama3,
    requires=['auto_gptq'],
    torch_dtype=torch.float16,
...
@register_model(
    ...
    '/home/ph/LLM/llama3/Meta-Llama-3-8B-Instruct',
    LoRATM.llama2,
    TemplateType.llama3,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/llama3-Chinese-chat-main/Llama3-Chinese_v2',
    LoRATM.llama2,
    TemplateType.default_generation,
    support_flash_attn=True,
    support_vllm=True,
...
@register_model(
    ...
    '/home/ph/LLM/llama3-Chinese-chat-main/llama-3-8b-Instruct-chinese_v2',
    LoRATM.llama2,
    TemplateType.llama3,
    support_flash_attn=True,
    support_vllm=True,
