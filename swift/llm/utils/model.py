...
@register_model(
    ...
    '/home/ph/LLM/Baichuan-13B-main/Baichuan2-13B-Chat',
    LoRATM.baichuan,
    TemplateType.baichuan,
    support_vllm=True)
@register_model(
...
@register_model(
    ...
    '/home/ph/LLM/ChatGLM2-6B-main/chatglm2-6b-32k',
    LoRATM.chatglm,
    TemplateType.chatglm2,
    support_vllm=True)
@register_model(
    ModelType.chatglm2_6b,
    '/home/ph/LLM/ChatGLM2-6B-main/chatglm2-6b/',
    LoRATM.chatglm,
    TemplateType.chatglm2,
    support_vllm=True)
@register_model(
...
def get_model_tokenizer(
    ...
    if model_dir is None:
        if is_dist() and not is_local_master():
            dist.barrier()    # 同步操作，用于让所有进程在这一点上等待，直到每个进程都到达这一点后才继续执行。
